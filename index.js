...
client.on('message', (message) => {
  ...
  if(message.content == '봇아 넌 어디서 왔니?') {
    return message.reply('저는 포항독서실틀니셔틀김삿두#1908님으로 인해 만들어진 생명체입니다.');
  }
  ...
  if(message.content == '!서버정보') {
    ...
    let commandList = [
      ...
      {name: '봇아 넌 어디서 왔니?', desc: '봇이 대답합니다'},
    ];
    let commandStr = '';
    let embed = new Discord.RichEmbed()
  ...
  if (message.content === '/온') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setThumbnail(img)
      .addField('디스코드', 'https://discord.gg/nv73rz/n')
      .addBlankField()
      .setTimestamp()
