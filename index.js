...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '트위치는 따앙구 검색하셔서 팔로우 ! 유튜브는 검색창에다가 땅구 검색하셔서 구독 한번씩만 부탁할께요 ㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠ' }, status: 'online' })
});
...
client.on('message', (message) => {
  ...
  if(message.content == '!서버정보') {
    ...
    let img = 'https://cdn.discordapp.com/attachments/717385004161695785/723138064976969738/Black_and_Cream_Hair_Stylist_Fashion_Logo_2.png';
    ...
    let helpImg = 'https://cdn.discordapp.com/attachments/717385004161695785/723138064976969738/Black_and_Cream_Hair_Stylist_Fashion_Logo_2.png';
    let commandList = [
      ...
      {name: '!공지사항 (할말)', desc: '공지사항을 쓸 수 있습니다.'},
      {name: '!가위바위보 (주먹, 보, 가위)', desc: '가위바위보를 할 수 있습니다.'},	  
      {name: '!안티링크불허용', desc: '링크를 못 보내게 합니다.'},	
      {name: '!안티링크허용', desc: '링크를 보낼 수 있게 합니다.'},	
    ];
    let commandStr = '';
    let embed = new Discord.RichEmbed()
  ...
  if(message.content == '!관리자신청서') {
    ...
    let embed = new Discord.RichEmbed()
      .setTitle('관리자 신청란')
      .setURL('https://discord.gg/5Mygbfw')
  ...
  if (message.content === '/온') {
    ...
    let img =
      'https://cdn.discordapp.com/attachments/717385004161695785/723138064976969738/Black_and_Cream_Hair_Stylist_Fashion_Logo_2.png';
    let embed = new Discord.RichEmbed()
      .setTitle('서버가 열렸습니다')
      .setColor(0x00ff3c)
      .setAuthor('땅구 SERVER', img)
      .setThumbnail(img)
      .addField('디스코드', 'https://discord.gg/5Mygbfw')
      .addBlankField()
      .setTimestamp()
      .setFooter('땅구서버 관리진', img);
