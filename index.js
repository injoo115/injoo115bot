...
client.on('message', (message) => {
  ...
  if(message.content == '!출근') {
	  if(!message.member.roles.find(r => r.name === "개발자 (디스코드) (플러그인)")) return message.channel.send('당신은 권한이 없습니다.') ||!message.member.roles.find(r => r.name === "운영자(총관리자)") || !message.member.roles.find(r => r.name === "부운영자") || if(!message.member.roles.find(r => r.name === "디스코드 관리자") || !message.member.roles.find(r => r.name === "상급 관리자") || !message.member.roles.find(r => r.name === "상급 관리자") || !message.member.roles.find(r => r.name === "중급 관리자") || !message.member.roles.find(r => r.name === "하급 관리자") || !message.member.roles.find(r => r.name === "임시관리자")) return message.channel.send('당신은 권한이 없습니다.')
