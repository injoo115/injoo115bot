...
client.on('message', (message) => {
  ...
  if(message.content == '!문의하기') {
    return message.reply('```문의가 접수되었습니다 !```');
  }  
  ...
  if(message.content == '!서버정보') {
    ...
    let img = 'https://cdn.discordapp.com/attachments/716186476689489991/719960864849133688/Photography_Studio_Etsy_Shop_Icon.png';
    var duration = moment.duration(client.uptime).format(" D [일], H [시간], m [분], s [초]");
    embed.setColor('#186de6')
    embed.setAuthor('밀크서버', img)
    ...
    let helpImg = 'https://cdn.discordapp.com/attachments/716186476689489991/719960864849133688/Photography_Studio_Etsy_Shop_Icon.png';
    let commandList = [
      {name: '!BR', desc: '공지사항을 전송합니다'},
      {name: '!공지', desc: 'dm으로 전체 공지를 보넴니다'},
      {name: '!CS', desc: '텍스트를 지움니다'},
      {name: '!초대코드', desc: '해당 채널의 초대 코드 표기'},
    ];
    let commandStr = '';
    let embed = new Discord.RichEmbed()
      .setAuthor('밀크 SERVER', helpImg)
      .setColor('#186de6')
      .setFooter(`밀크 SERVER`)
      .setTimestamp()
  ...
  if(message.content == '!관리자신청서') {
    ...
    let embed = new Discord.RichEmbed()
      .setTitle('관리자 신청란')
      .setURL('https://discord.gg/8QSdkGt')
      .setAuthor('밀크서버 관리진', img, 'https://discord.gg/HzCZFAz')
      .setThumbnail(img)
      .addBlankField()
  ...
  if (message.content === '/온') {
    ...
    let img =
      'https://cdn.discordapp.com/attachments/716186476689489991/719960864849133688/Photography_Studio_Etsy_Shop_Icon.png';
    let embed = new Discord.RichEmbed()
      .setTitle('서버가 열렸습니다')
      .setColor(0x00ff3c)
      .setAuthor('밀크 SERVER', img)
      .setThumbnail(img)
      .addField('디스코드', 'https://discord.gg/8QSdkGt')
      .addBlankField()
      .setTimestamp()
      .setFooter('밀크서버 관리진', img);
