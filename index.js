...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '꺼북서버에서 일하는중' }, status: 'online' })
});
...
client.on('message', (message) => {
  ...
  if(message.content == '!서버정보') {
    ...
    let img = 'https://cdn.discordapp.com/attachments/707430389614116864/728742317267091477/1.jpg';
    var duration = moment.duration(client.uptime).format(" D [일], H [시간], m [분], s [초]");
    embed.setColor('#186de6')
    embed.setAuthor('꺼북서버', img)
    ...
    let helpImg = 'https://cdn.discordapp.com/attachments/707430389614116864/728742317267091477/1.jpg';
    let commandList = [
  ...
  if(message.content == '!관리자신청서') {
    ...
    let embed = new Discord.RichEmbed()
      .setTitle('관리자 신청란')
      .setURL('https://discord.gg/5HY9vnb')
      .setAuthor('꺼북서버 관리진', img, 'https://discord.gg/HzCZFAz')
      .setThumbnail(img)
      .addBlankField()
  ...
  if (message.content === '/온') {
    ...
    let img =
      'https://cdn.discordapp.com/attachments/707430389614116864/728742317267091477/1.jpg';
    let embed = new Discord.RichEmbed()
      .setTitle('서버가 열렸습니다')
      .setColor(0x00ff3c)
      .setAuthor('꺼북 SERVER', img)
      .setThumbnail(img)
      .addField('디스코드', 'https://discord.gg/5HY9vnb')
      .addBlankField()
      .setTimestamp()
      .setFooter('꺼북서버 관리진', img);
