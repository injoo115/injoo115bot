...
if (message.content === '!팀투') {
  ...
  let embed = new Discord.RichEmbed()
    ...
    .setAuthor('제네시스 서버 관리자', img)
    .setThumbnail(img)
    .addField('자기소개', '안녕하세요 관리 팀장 팀투라고합니다 잘부탁드립니다.')
    .addBlankField()
    .setTimestamp()
    .setFooter('팀투', img);
...
if (message.content === '!진') {
  let img =
    'https://cdn.discordapp.com/avatars/700198049787412543/7d5d748685591afa2a544ab4ad59fe54.webp?size=128';
  let embed = new Discord.RichEmbed()
    .setTitle('진')
    .setColor(0xAFA7AF)
    .setAuthor('제네시스 서버 관리자', img)
    .setThumbnail(img)
    .addField('자기소개', '안녕하세요 전 jin1215k, 줄여서 진이라고 부르시고요 관리자중에 겜은 제가 젤 잘합니다^^')
    .addBlankField()
    .setTimestamp()
    .setFooter('진', img);
...
if (message.content === '!똥견') {
  ...
  let embed = new Discord.RichEmbed()
    ...
    .setAuthor('제네시스 서버 관리자', img)
    .setThumbnail(img)
    .addField('자기소개', '올해 2006년생 만 13살 잼민이니까 막다루세요(?)')
    .addBlankField()
    .setTimestamp()
    .setFooter('똥견', img);
...
if (message.content === '!PLAS') {
  ...
  let embed = new Discord.RichEmbed()
    ...
    .setThumbnail(img)
    .addField('자기소개', '안녕하세요 서버운영자이자 제네시스 서버 대표인 PLAS라고 합니다 잘 부탁드립니다')
    .addBlankField()
    .setTimestamp()
    .setFooter('PLAS', img);
